            ...
            <div className=" bg-white p-2 rounded shadow-sm">
              <div className="d-flex align-items-baseline">
                ...
                <div className="d-flex flex-column primary-front-color">
                  <p className="fw-bold p-0">Type</p>
                  <small className="p-0">Solid/inflatable</small>
                </div>
              </div>
              {/*  */}
              <div className="d-flex align-items-baseline">
                ...
                <div className="d-flex flex-column primary-front-color">
                  <p className="fw-bold p-0">Best for</p>
                  <small className="p-0">Flat water/Performance / Racing</small>
                </div>
              </div>
              {/*  */}
              <div className="d-flex align-items-baseline">
                ...
                <div className="d-flex flex-column primary-front-color">
                  <p className="fw-bold p-0">Size</p>
                  <small className="p-0">-120" /120"-144"/ +144"</small>
                </div>
              </div>
            </div>
          </Col>
